...
Usage: python scripts/generate_html_report.py
Output: report.html
"""
        ...
        <div class="content">
            ...
            <section id="executive">
                ...
                <ul>
                    ...
                    <li>✅ <strong>Stacked ensemble method</strong> with learned non-negative meta-weights</li>
            ...
            <section id="overview">
                ...
                <h3>Recursive Daylight Metrics Chart</h3>
                <div class="highlight info">
                    <p><strong>Generated chart:</strong> <code>output_images_v3/recursive_daylight_metrics_bar_chart.png</code></p>
                    <p>The chart compares MAE, RMSE, and R² for all models on the 24-hour recursive daylight backtest.</p>
                </div>
                <p>
                    Open the image directly: <code>output_images_v3/recursive_daylight_metrics_bar_chart.png</code>
                </p>
            </section>
            ...
            <section id="models">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td>Daylight RMSE</td><td><strong>15.78 kW</strong></td></tr>
                        <tr><td>Inference Time</td><td>3 ms</td></tr>
                        <tr><td>Model Size</td><td>2.5 MB</td></tr>
                        <tr><td>R² Score</td><td>0.8737</td></tr>
                    </tbody>
                </table>
                ...
                <table>
                    ...
                    <tbody>
                        <tr style="background: #d4edda; font-weight: bold;">
                            <td>🥇 Stacked Ensemble (RF + PatchTST + TFT + CNN+Transformer)</td>
                            <td>15.69</td>
                            <td>10.18</td>
                            <td>0.8751</td>
                            <td>648</td>
            ...
            <!-- Ensemble -->
            <section id="ensemble">
                <h2>🔄 Stacked Ensemble Method</h2>
                
                <h3>Why Stacking?</h3>
                <div class="highlight info">
                    The stacked model combines top recursive performers and learns non-negative weights from daylight backtests.
                    This improved daylight recursive accuracy over any single model in the latest run.
                </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><strong>Temporal Fusion Transformer</strong></td>
                            <td><strong>0.00%</strong></td>
                            <td>39.25 kW</td>
                            <td>Not selected by meta-learner</td>
                        </tr>
                        <tr>
                ...
                <h3>Meta-Learner Formula</h3>
                <pre><code>Non-negative linear stacking (no intercept)
y_hat = Σ w_i * y_hat_i, where w_i >= 0
...
CNN+Transformer = 0.0000
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>15.78 kW</td>
                            <td><strong>15.69 kW</strong></td>
                            <td><strong>-0.09 kW</strong></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><strong>Holdout Daylight R²</strong></td>
                            <td>-</td>
                            <td><strong>0.7591</strong></td>
                ...
                <div class="highlight warning">
                    <strong>Note:</strong> The stacked model gives a small in-sample daylight gain over Random Forest.
                    Holdout daylight R² (0.7591) is lower, so monitor drift and retrain weights regularly.
                </div>
            </section>
...
# Run model inference from CLI
            ...
            <section>
                ...
                <ul>
                    ...
                    <li>✅ Non-negative linear stacked ensemble (RF + PatchTST + TFT + CNN+Transformer)</li>
